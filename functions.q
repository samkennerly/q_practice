...
// Use a lambda function to show perfect squares 1^2 thru 10^2.
...
// Here's a (naive) way to calculate factorials
show "Naive factorials"
factorial: { */ [1 + reverse til x] }
factorial[4]
show hline

// Use each-right (each-left) to repeat some operation over a list to the right (left)
...
// "Dot Apply," i.e. expand a list to be used as arguments to a function
